...
;(function($, window, document, undefined)
{
    ...
    Plugin.prototype = {
        ...
        setTree: function(details)
        {
            
            //alert(hello);
            /*jQuery.each( details, function( innerKey, innerValue ) {
                                           
                    alert(innerKey);alert(innerValue);
                                              
            });*/
                //This is for parent id and id value  
                
                //var el = this.dragEl.children(this.options.itemNodeName).first().parent('ol');
                //alert('Drop Parent'+el.parent().parent().find('.parent_id').val());
                //alert(el.find('.parent_id').val());
                //alert(el.find('.id').val());
        ...
        dragStop: function(e)
        {
            ...
            if(parentItem !== null && !parentItem.is('.' + this.options.rootClass))
                ...
                if(parentId == null)
                el.find('.parent_id').first().val(0);
                else
                el.find('.parent_id').first().val(parentId);
