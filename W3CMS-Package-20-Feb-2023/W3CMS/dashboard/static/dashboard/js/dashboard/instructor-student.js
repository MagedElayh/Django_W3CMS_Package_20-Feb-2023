...
(function($) {
 ...
 var dlabChartlist = function(){
	...
	var screenWidth = $(window).width();
		...
		if(jQuery("#studentsActivity").length > 0){

			var chartArea = new ApexCharts(document.querySelector("#studentsActivity"), optionsArea);
			chartArea.render();
            
            jQuery('#dzStudentSeries').on('change',function(){
                jQuery(this).toggleClass('disabled');
                chartArea.toggleSeries('Persent');
            });
            
            jQuery('#dzVisitorsSeries').on('change',function(){
                jQuery(this).toggleClass('disabled'); 
                chartArea.toggleSeries('Visitors');
            });
